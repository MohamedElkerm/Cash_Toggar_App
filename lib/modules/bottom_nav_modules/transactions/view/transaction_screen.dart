                              ...
                              itemBuilder: (context, index) {
                                return Padding(
                                  ...
                                  child: TransactionCard(
                                    userName:
                                        homeCubit.allRecords[index].userName,
                                    transactionDate:
                                        homeCubit.formatFirebaseTimestamp(
                                            homeCubit.allRecords[index].time),
                                    transactionTime: "",
                                    transactionAmount:
                                        homeCubit.allRecords[index].amount,
                                    transactionGateway: homeCubit
                                        .allRecords[index].paymentMethod,
                                    paymentStatusEnum:
                                        homeCubit.allRecords[index].status,
